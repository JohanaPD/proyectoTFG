package org.example.proyectotfg.controllers.appointmentNotifiers.model;

import org.example.proyectotfg.controllers.appointmentNotifiers.validation.DataValidator;
...
public class CalendarEvent {
    ...
    public static final String[] DAYS_FULL_NAMES = {"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"};

    public static final String[] DAYS_SHORT_NAMES = {"Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"};

    public static final String[] DAYS_NAMES_LETTERS = {"M", "T", "W", "T", "F", "S", "S",};
     ...
     */
    public CalendarEvent(int id, String title, int priority, String description, int type, int periodicType, LocalDate date, String daysInWeek, int placeInMonth, LocalDate yearlyDate) {
        this.id = id;
        this.title = title;
        this.priority = priority;
        this.description = description;
        ...
        if (type == ONE_TIME_EVENT) {
            ...
            if (periodicType == CalendarEvent.PER_WEEK) {
                ...
                if (placeInMonth == CalendarEvent.START_OF_MONTH) {
                    ...
                    return localDate.getDayOfMonth() == month.atEndOfMonth().getDayOfMonth();
                }
            } else if (periodicType == CalendarEvent.PER_YEAR) {
                return localDate.getDayOfMonth() == getYearlyDateDay() && localDate.getMonthValue() == getYearlyDateMonth();
            }
        }
        return false;
    }
