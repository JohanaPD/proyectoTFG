package org.example.proyectotfg.controllers.appointmentNotifiers.dialog;
    ...
    public static void showErrorDialog(String errorMessage) {
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                alert.getDialogPane().setStyle(".dialog-pane > .content.label {-fx-padding: 0.5em 0.5em 0.5em 0.5em; -fx-font-size:14px;}");
                setDialogIcon(alert);
