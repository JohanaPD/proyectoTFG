...
public class SenderReaderMail {
    ...
    public Message crearNucleoMensaje(String emisor, String destinatario, String asunto)
    ...
    private Message crearMensajeTexto(String emisor, String destinatario, String asunto,
                                      String textoMensaje) throws MessagingException, AddressException, IOException {
        Message mensaje = crearNucleoMensaje(emisor, destinatario, asunto);
        mensaje.setText(textoMensaje);
        return mensaje;
    }

    public Message crearMensajeConAdjunto(String emisor, String destinatario, String asunto,
                                          String textoMensaje, String pathFichero) throws MessagingException, AddressException,
            IOException {
        Message mensaje = crearNucleoMensaje(emisor, destinatario, asunto);
        //Cuerpo del mensaje
    ...
    private Message crearMensajeHTML(String emisor, String destinatario, String asunto, String htmlContent)
            throws MessagingException, AddressException, IOException {
        Message mensaje = crearNucleoMensaje(emisor, destinatario, asunto);
    ...
    public void enviarMensajeHTML(String emisor, String destinatario, String asunto,
                                  String htmlContent, String direccionEmail, String password)
    ...
    public void leerCarpetaInbox(String email, String password) throws Exception{
        ...
        for (int i = 0; i < mensajes.length; i++) {
            ...
            if (mimeMultipart.getBodyPart(0).isMimeType("text/plain")) {
                ...
                System.out.printf("De %s A %s Asunto: %s Mensaje: %s\n",from,to,subject,
                        "El mensaje no solo está compuesto de texto plano");
            }
